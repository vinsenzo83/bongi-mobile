...
봉이모바일은 **광주/전라 지역 8개 직영 매장**을 운영하는 통신 판매 플랫폼이다. 휴대폰 개통, 요금제 변경, 인터넷/TV 결합상품 등 통신 상품 전반을 온라인과 오프라인에서 판매한다.
...
| AI 상담 | 없음 (봉이모바일 우위) | Claude API 연동 완료 | **완료** |
