...
> `menu-key`: **`call-stats`** · iframe: **`/docs/incentive-call-stats.html`**

> 라이브 캡쳐: `screens/08-call-stats.png`
...
## 2. 화면
![📈 콜 통계](screens/08-call-stats.png)

## 3. 소스 파일
- `docs/incentive-call-stats.html` · 353 lines · `<title>콜 통계</title>`
