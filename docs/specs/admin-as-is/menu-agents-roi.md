...
> `menu-key`: **`agents-roi`** · iframe: **`/docs/incentive-agents-roi.html`**

> 라이브 캡쳐: `screens/11-agents-roi.png`
...
## 2. 화면
![👥 상담사 ROI 비교](screens/11-agents-roi.png)

## 3. 소스 파일
- `docs/incentive-agents-roi.html` · 260 lines · `<title>👥 상담사 ROI 비교</title>`
