...
> `menu-key`: **`goals`** · iframe: **`/docs/incentive-goals.html`**

> 라이브 캡쳐: `screens/10-goals.png`
...
## 2. 화면
![🎯 월간 목표](screens/10-goals.png)

## 3. 소스 파일
- `docs/incentive-goals.html` · 279 lines · `<title>🎯 월간 목표 vs 실적</title>`
