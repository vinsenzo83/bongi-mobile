...
## 1. SK망 5개 (SK텔링크 제휴 · LGU+ 통신망 임차사 SK)

| # | plan_code | 이름 | 데이터 | 통화·문자 | 프로모 → 정가 | 약정 |
|---|---|---|---|---|---|---|
| S1 | `BONGI-SK-LITE-5GB` | SK 라이트 | 5GB + 1Mbps | 무제한 | **0원 × 7M → 19,900원** | 없음 |
| S2 | `BONGI-SK-BASIC-11GB` | SK 베이직 | 11GB + 매일 2GB + 3Mbps | 무제한 | **9,900원 × 7M → 38,900원** | 없음 |
| S3 | `BONGI-SK-JUMBO-100GB` | SK 점보 | 100GB + 5Mbps | 무제한 | **16,900원 × 7M → 39,800원** | 없음 |
| S4 | `BONGI-SK-5G-UNLIMITED` | SK 프리미엄 5G | 5G 완전 무제한 | 무제한 | **34,000원** (페이백 차감) | 24M |
| S5 | `BONGI-SK-SENIOR-1.5GB` | SK 시니어 | 1.5GB + 400kbps | 100분 / 100건 | **6,900원** (평생) | 없음 |

---

## 2. KT망 5개 (KT엠모바일 제휴 · KT 통신망)

| # | plan_code | 이름 | 데이터 | 통화·문자 | 프로모 → 정가 | 약정 |
|---|---|---|---|---|---|---|
| K1 | `BONGI-KT-LITE-7GB` | KT 라이트 | 7GB + 1Mbps | 무제한 | **0원 × 7M → 16,300원** | 없음 |
| K2 | `BONGI-KT-BASIC-11GB` | KT 베이직 | 11GB + 매일 2GB + 3Mbps | 무제한 | **9,900원 × 7M → 39,600원** | 없음 |
| K3 | `BONGI-KT-JUMBO-100GB` | KT 점보 ★ | 100GB + 5Mbps | 무제한 | **16,900원 × 7M → 40,700원** | 없음 |
| K4 | `BONGI-KT-5G-UNLIMITED` | KT 프리미엄 5G | 5G 완전 무제한 | 무제한 | **34,000원** (페이백 차감) | 24M |
| K5 | `BONGI-KT-SENIOR-3GB` | KT 시니어 | 3GB + 400kbps | 200분 / 무제한 | **7,700원** (평생) | 없음 |

★ KT 점보 = KT엠모바일 100GB 시장 1위 베스트셀러 대응

---

## 3. LG U+망 5개 (미디어로그 제휴 · LGU+ 통신망)

| # | plan_code | 이름 | 데이터 | 통화·문자 | 프로모 → 정가 | 약정 |
|---|---|---|---|---|---|---|
| L1 | `BONGI-LG-LITE-4.5GB` | LG 라이트 | 4.5GB + 1Mbps | 무제한 | **0원 × 7M → 20,900원** | 없음 |
| L2 | `BONGI-LG-BASIC-11GB` ★ | **LG 베이직** | 11GB + 매일 2GB + 3Mbps | 무제한 | **9,900원 × 7M → 39,600원** | 없음 |
| L3 | `BONGI-LG-JUMBO-100GB` | LG 점보 | 100GB + 5Mbps | 무제한 | **16,900원 × 7M → 40,700원** | 없음 |
| L4 | `BONGI-LG-5G-UNLIMITED` | LG 프리미엄 5G | 5G 완전 무제한 | 무제한 | **34,000원** (페이백 차감) | 24M |
| L5 | `BONGI-LG-HYODO-7GB` | LG 효도 | 7GB + 1Mbps | 무제한 | **11,900원** (평생) | 없음 |

★ **LG 베이직** = 전체 15 SKU 중 주력 (마케팅 예산 집중)
...
```
0원          → 라이트 3종 (S1·K1·L1) — 미끼·7개월 무료
6,900~7,700원 → 시니어 2종 (S5·K5) — 평생 동일
9,900원       → 베이직 3종 (S2·K2·L2) — 주력 (프로모 7M)
11,900원      → 효도 1종 (L5) — 평생 동일
16,900원      → 점보 3종 (S3·K3·L3) — 100GB 헤비
34,000원      → 프리미엄 3종 (S4·K4·L4) — 5G 완전 무제한 (페이백)
```
...
베이직  38,900~39,600원
점보    39,800~40,700원
프리미엄 59,000원 (실질 34,000원)
```

---

## 6. 사은품·페이백 정책 (베이직 ★ 주력 집중)

| SKU | 가입 즉시 | MNP 추가 | 유지 12개월 | 친구추천 |
|---|---|---|---|---|
| 베이직 (S2·K2·L2) | **5,000P** | **+5,000P** | **+5,000P** | **양쪽 10,000P** |
| 점보 (S3·K3·L3) | 3,000P | +3,000P | +3,000P | 양쪽 8,000P |
| 프리미엄 (S4·K4·L4) | 페이백 월 25,000원 × 24M | − | − | 양쪽 20,000P |
| 라이트 (S1·K1·L1) | 1,000P | − | − | 양쪽 5,000P |
| 시니어·효도 (S5·K5·L5) | 2,000P | − | +2,000P | 양쪽 5,000P |

---

## 7. SK·KT·LG 결합 할인 (봉이 단독)

- 가전렌탈·인터넷+TV 보유 시 알뜰폰 **월 2,000원 추가 할인**
- 가족 2회선 이상: 회선당 **월 1,000원 추가 할인** (최대 3회선)
- 친구결합 (가족 X 친구 가능 · KB리브엠 패턴): 회선당 **−1,100원 × 3회선**

---

## 8. SKU 마스터 시드 SQL (P1 마이그레이션)
